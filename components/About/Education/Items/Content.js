...
function Content() {
  return (
    <div>
      <Title />
      <div className="flex flex-col flex-wrap items-center justify-center h-full tablet:items-start tablet:flex-row">
        ...
        <div className="flex flex-wrap items-center my-12 justify-evenly">
